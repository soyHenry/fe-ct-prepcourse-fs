...
function crearGato(nombre, edad) {
  ...
  // Tu código:
  let newObjetc = {};
  newObjetc.nombre = nombre;
  newObjetc.edad = edad;
  newObjetc.meow = function () {
    return "Meow!";
  };
  return newObjetc;
}
...
function nuevoUsuario(nombre, email, password) {
  ...
  let newObjetc = {};
  newObjetc.nombre = nombre;
  newObjetc.email = email;
  newObjetc.password = password;
  return newObjetc;
}
...
function sumarLikesDeUsuario(objetoUsuario) {
  ...
  // Tu código:
  let total = 0;
  for (const key in objetoUsuario.posts) {
    total += objetoUsuario.posts[key].likes;
  }
  return total;
}
